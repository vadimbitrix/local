...
class HLBlock
{
    ...
    /**
     * Возвращает класс для работы с highload блоком
    ...
    /**
     * Возвращает ресурс результата списка элементов
     * @param int $hlblockID - идентификатор таблицы HL
     * @param array $arFilter - фильтры
     * @param array $arOrder - сортировка
     ...
     * @return bool
     * @since 1.0.3
     * @example \Dev2fun\MultiDomain\HLBlock::getInstance()
     *     ->removeFields(
     *          10,
